 ...
 */
export declare type MixedInParser = ParserConstructorImpel & ErrorHandler & LexerAdapter & LooksAhead & RecognizerApi & RecognizerEngine & Recoverable & TreeBuilder & ContentAssist;
interface MixedInParserConstructor {
    new (tokenVocabulary: defs.TokenVocabulary, config?: defs.IParserConfig): defs.Parser;
}
export declare const Parser: MixedInParserConstructor;
export {};
