import {createToken, Token, tokenLabel, tokenMatcher, tokenName} from "../../src/scan/tokens_public"
...
describe("The Chevrotain Tokens namespace", () => {
    ...
    context("createToken", () => {
        ...
        it("provides a utility to verify if a token instance matches a Token Type", () => {
            ...
            let AInstanceRegular = createTokenInstance(ATokRegular, "a", -1, -1, -1, -1, -1, -1)
            let BInstanceRegular = createTokenInstance(BTokRegular, "b", -1, -1, -1, -1, -1, -1)
