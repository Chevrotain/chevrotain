...
describe("GAst namespace", () => {
    ...
    describe("the GAst serialization capabilities", () => {
        ...
        it("can serialize a Option", () => {
            let input = new gast.Option([new Terminal(C), new NonTerminal("bamba")])
            let actual = serializeProduction(input)
            expect(actual).to.deep.equal({
                type:       "Option",
                definition: [
        ...
        it("can serialize a RepetitionMandatory", () => {
            let input = new gast.RepetitionMandatory([new Terminal(C), new NonTerminal("bamba")])
            let actual = serializeProduction(input)
            expect(actual).to.deep.equal({
        ...
        it("can serialize a RepetitionMandatoryWithSeparator", () => {
            let input = new gast.RepetitionMandatoryWithSeparator([new Terminal(C), new NonTerminal("bamba")], Comma)
            let actual = serializeProduction(input)
            expect(actual).to.deep.equal({
        ...
        it("can serialize a Repetition", () => {
            let input = new gast.Repetition([new Terminal(C), new NonTerminal("bamba")])
            let actual = serializeProduction(input)
            expect(actual).to.deep.equal({
                type:       "Repetition",
                definition: [
        ...
        it("can serialize a RepetitionWithSeparator", () => {
            let input = new gast.RepetitionWithSeparator([new Terminal(C), new NonTerminal("bamba")], Comma)
            let actual = serializeProduction(input)
            expect(actual).to.deep.equal({
        ...
        it("can serialize a Rule", () => {
            let input = new gast.Rule("myRule", [new Terminal(C), new NonTerminal("bamba")])
            let actual = serializeProduction(input)
            expect(actual).to.deep.equal({
                type:       "Rule",
                name:       "myRule",
        ...
        it("can serialize an array of Rules", () => {
            let input = [
                new gast.Rule("myRule", [new Terminal(C), new NonTerminal("bamba")]),
                new gast.Rule("myRule2", [new Terminal(D), new NonTerminal("bisli")])]
