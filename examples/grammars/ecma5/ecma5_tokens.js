...
export const LCurly = createToken({ name: "LCurly", categories: AbsPunctuator })
export const RCurly = createToken({ name: "RCurly", categories: AbsPunctuator })
export const LParen = createToken({ name: "LParen", categories: AbsPunctuator })
export const RParen = createToken({ name: "RParen", categories: AbsPunctuator })
...
export const Eq = createToken({ name: "Eq", categories: AbsAssignmentOperator })
