module ecma5 {
    ...
    export class ECMAScript5Parser extends Parser {
         ...
         *    }
         */
        constructor(input:Token[] = [], protected lineTerminatorsInfo:lexer.IdxToLineTerminator = {}) {
            super(input, <any>ecma5)
        ...
        protected canAndShouldDoSemiColonInsertion():boolean {
            ...
            return !isNextTokenSemiColon &&
                ...
                this.NEXT_TOKEN() instanceof EOF)  // basic rule 2
        }

        protected CONSUME(tokClass:Function, trySemiColonInsertion = false):Token {
        ...
        protected CONSUME2(tokClass:Function, trySemiColonInsertion = false):Token {
            if (trySemiColonInsertion && this.canAndShouldDoSemiColonInsertion()) {
                var insertedSemiColon = new Semicolon(";", -1, -1, -1)
                insertedSemiColon.isAutomaticSemiColonInsertion = true
                return insertedSemiColon
        ...
        protected canInComeAfterExp(exp:ParseTree):boolean {
        ...
        public ThrowStatement = this.RULE("ThrowStatement", () => {
            ...
            if (this.isNextLineTerminator()) {
                ...
                this.SAVE_ERROR(new exceptions.MismatchedTokenException(
