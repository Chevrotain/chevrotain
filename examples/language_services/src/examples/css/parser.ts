...
export class CssParser extends Parser {
    ...
    attrib = this.RULE("attrib", function () {
        let lSquareTok, identTok, operator = undefined, value = undefined, rSquareTok
        ...
        return PT(AttribPT,
            CHILDREN(identTok, operator, value,
    ...
    attrib_relation = this.RULE("attrib_relation", function () {
        ...
        return PT(AttribRelationPT,
            CHILDREN(operatorTok,
                // TODO: should we fill up the syntax box or extract afterwards?
