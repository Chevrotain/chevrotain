...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = global || self, factory(global.cursornext = {}));
  ...
  ***************************************************************************** */
  ...
  function () {
    ...
    Cursor.prototype.getLoc = function () {
      ...
      this.compute();
      var line = this.eols.findIndex(function (eol) {
        return _this.index <= eol.start;
      });
    ...
    Cursor.prototype.extractLine = function (line, includeEol) {
      ...
      if (line > 0 && line <= this.numberOfLines()) {
        ...
        var end = includeEol ? this.eols[line].end : this.eols[line].start;
    ...
    Cursor.prototype.startsWith = function (compareString) {
      ...
      for (var index = 0, docIndex = this.index, len = compareString.length; index < len; ++index, ++docIndex) {
    ...
    Cursor.prototype.exec = function (input) {
      var regExp = input.global ? input : new RegExp(input);
    ...
    Cursor.prototype.isAt = function (cursorOrIndex) {
      var index = typeof cursorOrIndex === 'number' ? cursorOrIndex : cursorOrIndex.index;
    ...
    Cursor.prototype.printDebug = function (_a) {
      ...
      for (var i = -1; i < 2; ++i) {
        ...
        if (line !== undefined) {
          var outputLine = lineNumber.toString().padStart(padLength) + ' | ' + line;
          lines.push(outputLine);

          if (lineNumber === loc.line) {
            var markerLine = ''.padStart(padLength) + ' | ' + ' '.repeat(loc.column - 1) + '^';
            lines.push(markerLine);

            if (label) {
              var labelLine = ''.padStart(padLength) + ' | ' + ' '.repeat(loc.column - 1) + label;
  ...
  function () {
    ...
    CaptureBuffer.prototype.toCaptureResult = function (doc) {
      return new CaptureResult(doc, this.indexes.sort(function (a, b) {
        return a[1] - b[1];
      }));
    };
    ...
    CaptureResult.prototype.toMap = function () {
      ...
      try {
        for (var indexes_1 = __values(indexes), indexes_1_1 = indexes_1.next(); !indexes_1_1.done; indexes_1_1 = indexes_1.next()) {
          var _b = __read(indexes_1_1.value, 2),
              label = _b[0],
              index = _b[1];
    ...
    CaptureResult.prototype.toIter = function () {
      ...
      try {
        for (var indexes_2 = __values(indexes), indexes_2_1 = indexes_2.next(); !indexes_2_1.done; indexes_2_1 = indexes_2.next()) {
          var _b = __read(indexes_2_1.value, 2),
              index = _b[1];
    ...
    CaptureResult.prototype.toPairs = function () {
      ...
      var _loop_1 = function (label, index) {
        ...
        if (matchResult) {
          ...
          if (prefix === 'start') {
            ...
            if (itemIndex !== -1) {
              var _b = __read(list.splice(itemIndex, 1), 1),
                  _c = __read(_b[0], 2),
                  lastIndex = _c[1];
          ...
          if (stack.length) {
            var _d = __read(stack[stack.length - 1], 2),
                lastLabel = _d[0],
                lastIndex = _d[1];
      ...
      try {
        for (var indexes_3 = __values(indexes), indexes_3_1 = indexes_3.next(); !indexes_3_1.done; indexes_3_1 = indexes_3.next()) {
          var _b = __read(indexes_3_1.value, 2),
              label = _b[0],
              index = _b[1];
  ...
  function () {
    ...
    CursorTest.prototype.block = function (input, _testOptions) {
      ...
      while (!cursor.isEof()) {
        var regexpArray = cursor.exec(/^[ \t]*([0-9]+)?[ \t]*\|[ \t](.*?)$/gmy);
