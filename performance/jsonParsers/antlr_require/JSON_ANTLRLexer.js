...
function JSON_ANTLRLexer(input) {
    antlr4WithRequire.Lexer.call(this, input);
    this._interp = new antlr4WithRequire.atn.LexerATNSimulator(this, atn, decisionsToDFA, new antlr4WithRequire.PredictionContextCache());
    return this;
}

JSON_ANTLRLexer.prototype = Object.create(antlr4WithRequire.Lexer.prototype);
JSON_ANTLRLexer.prototype.constructor = JSON_ANTLRLexer;

JSON_ANTLRLexer.EOF = antlr4WithRequire.Token.EOF;
...
exports.JSON_ANTLRLexer = JSON_ANTLRLexer;
