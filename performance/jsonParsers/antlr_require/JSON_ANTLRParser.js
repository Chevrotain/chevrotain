...
// jshint ignore: start
var JSON_ANTLRListener = require('./JSON_ANTLRListener').JSON_ANTLRListener;
...
var atn = new antlr4WithRequire.atn.ATNDeserializer().deserialize(serializedATN);

var decisionsToDFA = atn.decisionToState.map( function(ds, index) { return new antlr4WithRequire.dfa.DFA(ds, index); });

var sharedContextCache = new antlr4WithRequire.PredictionContextCache();
...
function JSON_ANTLRParser (input) {
    antlr4WithRequire.Parser.call(this, input);
    this._interp = new antlr4WithRequire.atn.ParserATNSimulator(this, atn, decisionsToDFA, sharedContextCache);
...
JSON_ANTLRParser.prototype = Object.create(antlr4WithRequire.Parser.prototype);
...
JSON_ANTLRParser.EOF = antlr4WithRequire.Token.EOF;
...
JSON_ANTLRParser.STRING = 10;
JSON_ANTLRParser.NUMBER = 11;
JSON_ANTLRParser.WS = 12;
...
function JsonContext(parser, parent, invokingState) {
    ...
    antlr4WithRequire.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = JSON_ANTLRParser.RULE_json;
    return this;
}

JsonContext.prototype = Object.create(antlr4WithRequire.ParserRuleContext.prototype);
    ...
    try {
        ...
        switch(this._input.LA(1)) {
            ...
            case JSON_ANTLRParser.T__4:
                ...
                break;
            default:
                throw new antlr4WithRequire.error.NoViableAltException(this);
        }
    } catch (re) {
        if(re instanceof antlr4WithRequire.error.RecognitionException) {
...
ObjectContext.prototype = Object.create(antlr4WithRequire.ParserRuleContext.prototype);
...
PairContext.prototype = Object.create(antlr4WithRequire.ParserRuleContext.prototype);
...
ArrayContext.prototype = Object.create(antlr4WithRequire.ParserRuleContext.prototype);
...
ValueContext.prototype = Object.create(antlr4WithRequire.ParserRuleContext.prototype);
...
exports.JSON_ANTLRParser = JSON_ANTLRParser;
