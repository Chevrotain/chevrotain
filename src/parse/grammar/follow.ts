...
export class ResyncFollowsWalker extends RestWalker {
    ...
    constructor(private topProd:gast.Rule) { super() }
...
export function computeAllProdsFollows(topProductions:gast.Rule[]):HashTable<Function[]> {
...
export function buildBetweenProdsFollowPrefix(inner:gast.Rule, occurenceInParent:number):string {
