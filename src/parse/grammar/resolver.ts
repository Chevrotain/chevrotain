...
import {IParserDefinitionError, IParserUnresolvedRefDefinitionError, ParserDefinitionErrorType} from "../parser_public"
import {gast} from "./gast_public"
import {forEach} from "../../utils/utils"

export function resolveGrammar(topLevels:HashTable<gast.Rule>):IParserDefinitionError[] {
...
export class GastRefResolverVisitor extends gast.GAstVisitor {
    ...
    constructor(private nameToTopRule:HashTable<gast.Rule>) { super() }
