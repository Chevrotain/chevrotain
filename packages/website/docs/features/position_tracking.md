...
The level of position information tracking can be reduced by using the [**positionTracking**](https://chevrotain.io/documentation/10_4_0/interfaces/ILexerConfig.html#positionTracking) lexer config option.
For example:
