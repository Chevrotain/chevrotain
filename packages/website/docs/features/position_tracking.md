...
The level of position information tracking can be reduced by using the [**positionTracking**](https://chevrotain.io/documentation/8_0_1/interfaces/ilexerconfig.html#positiontracking) lexer config option.
For example:
