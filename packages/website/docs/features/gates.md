...
Using the [Look Ahead](https://chevrotain.io/documentation/13_0_0/classes/CstParser.html#LA) method is often helpful with the use of Gates to determine if a path should be followed or not, for example:
