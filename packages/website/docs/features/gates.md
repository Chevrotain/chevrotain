...
Using the [Look Ahead](https://chevrotain.io/documentation/11_1_1/classes/CstParser.html#LA) method is often helpful with the use of Gates to determine if a path should be followed or not, for example:
