...
To group a Token Type simply specify the [**group**](https://chevrotain.io/documentation/9_0_0/interfaces/itokenconfig.html#group) property in its configuration.
For example:
