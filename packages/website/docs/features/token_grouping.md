...
To group a Token Type simply specify the [**group**](https://chevrotain.io/documentation/10_1_0/interfaces/ITokenConfig.html#group) property in its configuration.
For example:
