...
- [canTokenTypeBeInsertedInRecovery](https://chevrotain.io/documentation/13_2_0/classes/CstParser.html#canTokenTypeBeInsertedInRecovery)

- [getTokenToInsert](https://chevrotain.io/documentation/13_2_0/classes/CstParser.html#getTokenToInsert)
...
- [canTokenTypeBeDeletedInRecovery](https://chevrotain.io/documentation/13_2_0/classes/CstParser.html#canTokenTypeBeDeletedInRecovery)
...
to the parser's [constructor](https://chevrotain.io/documentation/13_2_0/classes/CstParser.html#constructor).

Once enabled, specific rules may have their re-sync recovery disabled explicitly.
This can be done during the definition of the grammar rule [RULE](https://chevrotain.io/documentation/13_2_0/classes/CstParser.html#RULE).
...
a re-synced rule will return a CstNode with the boolean ["recoveredNode"](https://chevrotain.io/documentation/13_2_0/interfaces/CstNode.html#recoveredNode) flag marked as true.
...
Customization is done during the definition of the grammar [RULE](https://chevrotain.io/documentation/13_2_0/classes/CstParser.html#RULE).
