...
- [canTokenTypeBeInsertedInRecovery](https://chevrotain.io/documentation/11_0_2/classes/CstParser.html#canTokenTypeBeInsertedInRecovery)

- [getTokenToInsert](https://chevrotain.io/documentation/11_0_2/classes/CstParser.html#getTokenToInsert)
...
- [canTokenTypeBeDeletedInRecovery](https://chevrotain.io/documentation/11_0_2/classes/CstParser.html#canTokenTypeBeDeletedInRecovery)
...
To the parser's constructor [constructor](https://chevrotain.io/documentation/11_0_2/classes/CstParser.html#constructor).

Once enabled specific rules may have their re-sync recovery disabled explicitly,
This is can be done during the definition of the grammar rule [RULE](https://chevrotain.io/documentation/11_0_2/classes/CstParser.html#RULE).
...
A re-synced will return a CSTNode with the boolean ["recoveredNode"](https://chevrotain.io/documentation/11_0_2/interfaces/CstNode.html#recoveredNode) flag marked as true.
...
Customization is done during the definition of the grammar [RULE](https://chevrotain.io/documentation/11_0_2/classes/CstParser.html#RULE).
