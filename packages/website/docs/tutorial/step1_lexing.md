...
A Lexer transforms a string input into a [Token](https://chevrotain.io/documentation/13_2_0/interfaces/IToken.html) vector.
...
There is nothing much to it. We simply use the [**createToken** API](https://chevrotain.io/documentation/13_2_0/modules.html#createToken)
