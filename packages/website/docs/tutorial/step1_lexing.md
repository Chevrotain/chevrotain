...
A Lexer transforms a string input into a [Token](https://chevrotain.io/documentation/10_0_0/interfaces/IToken.html) vector.
...
There is nothing much to it. We simply use the [**createToken** API](https://chevrotain.io/documentation/10_0_0/modules.html#createToken)
