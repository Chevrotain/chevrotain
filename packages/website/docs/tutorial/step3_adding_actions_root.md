...
The main difference between the two approaches is with regard to the question:
...
- The parsing step is normally just one step in a larger flow. A large performance penalty in one step
