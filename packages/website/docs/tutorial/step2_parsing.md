...
A Chevrotain Parser analyses an [IToken](https://chevrotain.io/documentation/11_1_1/interfaces/IToken.html) vector that conforms to some grammar.
The grammar is defined using the [parsing DSL](https://chevrotain.io/documentation/11_1_1/classes/CstParser.html#AT_LEAST_ONE), which includes the following methods.
