...
- No need to learn a new syntax, as Chevrotain is a **pure** JavaScript library. Instead, the problem is reduced to learning a new API.
...
- **Performance**: Chevrotain is generally faster (often much more so) than other existing JavaScript Parsing Solutions.
  It can even compete with the performance of hand-built parsers.
...
when the parser uses a larger than the default [maxLookahead](https://chevrotain.io/documentation/11_1_2/interfaces/IParserConfig.html)
