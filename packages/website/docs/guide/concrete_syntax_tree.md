...
This feature is enabled when a parser extends the [CstParser class](https://chevrotain.io/documentation/12_0_0/classes/CstParser.html).
...
- See the full [CstNode type signature](https://chevrotain.io/documentation/12_0_0/interfaces/CstNode.html)
...
by setting the IParserConfig [nodeLocationTracking](https://chevrotain.io/documentation/12_0_0/interfaces/IParserConfig.html#nodeLocationTracking)
to:
...
Once this feature is enabled, the optional [location property](https://chevrotain.io/documentation/12_0_0/interfaces/CstNode.html#location)
...
- In order to track the CstNodes location **every** Token in the input Token vector must include its own location information.
  - This is enabled by default in the Chevrotain Lexer. See [ILexerConfig.positionTracking](https://chevrotain.io/documentation/12_0_0/interfaces/ILexerConfig.html#positionTracking).
...
This capability is provided via the [generateCstDts](https://chevrotain.io/documentation/12_0_0/modules.html#generateCstDts) function,
...
Note that the [generateCstDts](https://chevrotain.io/documentation/12_0_0/modules.html#generateCstDts) function
