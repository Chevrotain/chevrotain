...
This feature is enabled when a parser extends the [CstParser class](https://chevrotain.io/documentation/9_0_1/classes/cstparser.html).
...
- See the full [CstNode type signature](https://chevrotain.io/documentation/9_0_1/interfaces/cstnode.html)
...
by setting the IParserConfig [nodeLocationTracking](https://chevrotain.io/documentation/9_0_1/interfaces/iparserconfig.html#nodelocationtracking)
to:
...
Once this feature is enabled the optional [location property](https://chevrotain.io/documentation/9_0_1/interfaces/cstnode.html#location)
...
- In order to track the CstNodes location **every** Token in the input Token vector must include its own location information.
  ...
  - This is enabled by default in the Chevrotain Lexer, See [ILexerConfig.positionTracking](https://chevrotain.io/documentation/9_0_1/interfaces/ilexerconfig.html#positiontracking).
