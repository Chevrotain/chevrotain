...
Chevrotain provides the [**createSyntaxDiagramsCode**](https://chevrotain.io/documentation/10_3_0/modules.html#createsyntaxdiagramscode) API to generate the **html source code**
