...
Chevrotain provides the [**createSyntaxDiagramsCode**](https://chevrotain.io/documentation/13_2_0/modules.html#createsyntaxdiagramscode) API to generate the **HTML source code**
