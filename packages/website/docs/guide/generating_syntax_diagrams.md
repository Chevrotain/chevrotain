...
Chevrotain provides the [**createSyntaxDiagramsCode**](https://chevrotain.io/documentation/8_0_1/globals.html#createsyntaxdiagramscode) API to generate the **html source code**
