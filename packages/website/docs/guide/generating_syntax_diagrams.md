...
Chevrotain provides the [**createSyntaxDiagramsCode**](https://chevrotain.io/documentation/11_1_0/modules.html#createsyntaxdiagramscode) API to generate the **html source code**
