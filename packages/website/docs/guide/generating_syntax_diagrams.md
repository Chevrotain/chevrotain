...
Chevrotain provides the [**createSyntaxDiagramsCode**](https://chevrotain.io/documentation/10_1_1/modules.html#createsyntaxdiagramscode) API to generate the **html source code**
