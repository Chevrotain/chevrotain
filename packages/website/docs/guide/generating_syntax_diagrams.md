...
Chevrotain provides the [**createSyntaxDiagramsCode**](https://chevrotain.io/documentation/9_1_0/modules.html#createsyntaxdiagramscode) API to generate the **html source code**
