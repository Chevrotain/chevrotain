...
Chevrotain provides the [**createSyntaxDiagramsCode**](https://chevrotain.io/documentation/9_0_1/modules.html#createsyntaxdiagramscode) API to generate the **html source code**
