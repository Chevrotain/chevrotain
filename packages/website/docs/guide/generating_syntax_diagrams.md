...
Chevrotain provides the [**createSyntaxDiagramsCode**](https://chevrotain.io/documentation/12_0_0/modules.html#createsyntaxdiagramscode) API to generate the **HTML source code**
