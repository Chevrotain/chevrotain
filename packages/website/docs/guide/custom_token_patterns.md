...
The basic syntax for supplying a custom pattern is defined by the [ICustomPattern](https://chevrotain.io/documentation/11_1_1/interfaces/ICustomPattern.html) interface.
Example:
...
createToken({
  ...
  // See: https://chevrotain.io/documentation/11_1_1/interfaces/ITokenConfig.html#start_chars_hint
