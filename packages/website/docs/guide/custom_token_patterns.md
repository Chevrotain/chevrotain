...
The basic syntax for supplying a custom pattern is defined by the [ICustomPattern](https://chevrotain.io/documentation/11_0_0/interfaces/ICustomPattern.html) interface.
Example:
...
createToken({
  ...
  // See: https://chevrotain.io/documentation/11_0_0/interfaces/ITokenConfig.html#start_chars_hint
...
It is important to note that The matchedTokens and groups arguments match the token and groups properties of the tokenize output ([ILexingResult](https://chevrotain.io/documentation/11_0_0/interfaces/ILexingResult.html)).
