...
The basic syntax for supplying a custom pattern is defined by the [ICustomPattern](https://chevrotain.io/documentation/10_1_2/interfaces/ICustomPattern.html) interface.
Example:
