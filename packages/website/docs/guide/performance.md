...
Simply override the Parser's [reset](https://chevrotain.io/documentation/11_0_1/classes/CstParser.html#reset) method
to accomplish that.
...
1.  **Reduce the amount of Token position tracking** the lexer performs.
    See The [ILexerConfig.positionTracking](https://chevrotain.io/documentation/11_0_1/interfaces/ILexerConfig.html) property.
