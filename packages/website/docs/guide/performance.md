...
Simply override the Parser's [reset](https://chevrotain.io/documentation/10_4_2/classes/CstParser.html#reset) method
to accomplish that.
...
If the TokenType's first charCodes cannot be automatically identified, you can set the [`start_chars_hint`](https://chevrotain.io/documentation/10_4_2/interfaces/ITokenConfig.html#start_chars_hint) property when calling `createToken()`. If you define a custom [pattern](https://chevrotain.io/documentation/10_4_2/interfaces/ITokenConfig.html#pattern) for your token, then you should set `start_chars_hint` manually for optimal performance.
...
1.  **Reduce the amount of Token position tracking** the lexer performs.
    See The [ILexerConfig.positionTracking](https://chevrotain.io/documentation/10_4_2/interfaces/ILexerConfig.html) property.
