...
To group a Token Type simply specify the [**group**](https://chevrotain.io/documentation/7_1_2/interfaces/itokenconfig.html#group) property in its configuration.
For example:
