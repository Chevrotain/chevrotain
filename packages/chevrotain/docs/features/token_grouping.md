...
To group a Token Type simply specify the [**group**](https://sap.github.io/chevrotain/documentation/7_0_1/interfaces/itokenconfig.html#group) property in its configuration.
For example:
