...
The level of position information tracking can be reduced by using the [**positionTracking**](https://sap.github.io/chevrotain/documentation/6_1_0/interfaces/ilexerconfig.html#positiontracking) lexer config option.
For example:
