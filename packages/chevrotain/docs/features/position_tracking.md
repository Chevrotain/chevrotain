...
The level of position information tracking can be reduced by using the [**positionTracking**](https://chevrotain.io/documentation/7_1_2/interfaces/ilexerconfig.html#positiontracking) lexer config option.
For example:
