...
The level of position information tracking can be reduced by using the [**positionTracking**](https://sap.github.io/chevrotain/documentation/7_0_1/interfaces/ilexerconfig.html#positiontracking) lexer config option.
For example:
