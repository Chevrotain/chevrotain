...
Using the [Look Ahead](https://chevrotain.io/documentation/8_0_0/classes/cstparser.html#la) method is often helpful with the use of Gates to determine if a path should be followed or not, for example:
