...
The basic syntax for supplying a custom pattern is defined by the [ICustomPattern](https://chevrotain.io/documentation/7_1_2/interfaces/icustompattern.html) interface.
Example:
...
createToken({
  ...
  // See: https://chevrotain.io/documentation/7_1_2/interfaces/itokenconfig.html#start_chars_hint
...
It is important to note that The matchedTokens and groups arguments match the token and groups properties of the tokenize output ([ILexingResult](https://chevrotain.io/documentation/7_1_2/interfaces/ilexingresult.html)).
