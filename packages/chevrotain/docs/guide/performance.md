...
Simply override the Parser's [reset](https://sap.github.io/chevrotain/documentation/4_4_0/classes/parser.html#reset) method
to accomplish that.
...
1.  **Reduce the amount of Token position tracking** the lexer performs.
    See The [ILexerConfig.positionTracking](https://sap.github.io/chevrotain/documentation/4_4_0/interfaces/ilexerconfig.html) property.
