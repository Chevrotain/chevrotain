...
This feature is enabled when a parser extends the [CstParser class](https://sap.github.io/chevrotain/documentation/7_0_0/classes/cstparser.html).
...
- See the full [CstNode type signature](https://sap.github.io/chevrotain/documentation/7_0_0/interfaces/cstnode.html)
...
by setting the IParserConfig [nodeLocationTracking](https://sap.github.io/chevrotain/documentation/7_0_0/interfaces/iparserconfig.html#nodelocationtracking)
to:
...
Once this feature is enabled the optional [location property](https://sap.github.io/chevrotain/documentation/7_0_0/interfaces/cstnode.html#location)
...
- In order to track the CstNodes location **every** Token in the input Token vector must include its own location information.
  ...
  - This is enabled by default in the Chevrotain Lexer, See [ILexerConfig.positionTracking](https://sap.github.io/chevrotain/documentation/7_0_0/interfaces/ilexerconfig.html#positiontracking).
