...
The phase-oriented Node CLI benchmark now lives in [`packages/benchmark`](../../benchmark/README.md).

That keeps the browser harness here and the PR-focused CLI benchmark separate.
