...
-   [canTokenTypeBeInsertedInRecovery](https://sap.github.io/chevrotain/documentation/4_1_1/classes/parser.html#cantokentypebeinsertedinrecovery)

-   [getTokenToInsert](https://sap.github.io/chevrotain/documentation/4_1_1/classes/parser.html#gettokentoinsert)
...
To the parser's constructor [constructor](https://sap.github.io/chevrotain/documentation/4_1_1/classes/parser.html#constructor).

Once enabled specific rules may have their re-sync recovery disabled explicitly,
This is can be done during the definition of the grammar rule [RULE](https://sap.github.io/chevrotain/documentation/4_1_1/classes/parser.html#rule).
...
A re-synced will return a CSTNode with the boolean ["recoveredNode"](https://sap.github.io/chevrotain/documentation/4_1_1/interfaces/cstnode.html#recoverednode) flag marked as true.
...
Customization is done during the definition of the grammar [RULE](https://sap.github.io/chevrotain/documentation/4_1_1/classes/parser.html#rule).
