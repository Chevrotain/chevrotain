...
### ---> [Source Code](https://github.com/SAP/chevrotain/blob/master/docs/tutorial/src/step3a_actions_visitor.js) for this step<---
...
This is easily done by passing the ["outputCst"](http://sap.github.io/chevrotain/documentation/0_28_1/interfaces/_chevrotain_d_.iparserconfig.html#outputcst) parser options object in
