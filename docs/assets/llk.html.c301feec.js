import{_ as t,r as i,o as r,c as s,a as e,b as o,e as n,d as l}from"./app.9a2b1ea3.js";const d={},c=e("h1",{id:"ll-k-grammars",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#ll-k-grammars","aria-hidden":"true"},"#"),n(" LL(K) Grammars")],-1),u=n("Chevrotain can be used to build parsers for "),m={href:"https://en.wikipedia.org/wiki/LL_grammar",target:"_blank",rel:"noopener noreferrer"},v=n("LL(K)"),h=n(" Grammars. This means that the number of lookahead tokens needed to disambiguate two alternatives must be a fixed number and known in advance."),b=l(`<p>For example given the grammar</p><div class="language-antlr ext-antlr line-numbers-mode"><pre class="language-antlr"><code>statement:
   A B C |
   A B D |
   A B E
