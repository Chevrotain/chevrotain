...
createToken({
    ...
    // See: https://sap.github.io/chevrotain/documentation/3_3_0/interfaces/itokenconfig.html#start_chars_hint
...
It is important to note that The matchedTokens and groups arguments match the token and groups properties of the tokenize output ([ILexingResult](https://sap.github.io/chevrotain/documentation/3_3_0/interfaces/ilexingresult.html)).
