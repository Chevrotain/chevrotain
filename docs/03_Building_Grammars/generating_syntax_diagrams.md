...
Chevrotain provides an the [**createSyntaxDiagramsCode**](http://sap.github.io/chevrotain/documentation/3_0_1/globals.html#createsyntaxdiagramscode) API to generate the **html source code**
