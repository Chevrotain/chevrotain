...
Chevrotain provides an the [**createSyntaxDiagramsCode**](http://sap.github.io/chevrotain/documentation/1_0_1/modules/html#createsyntaxdiagramscode) API to generate the **html source code**
