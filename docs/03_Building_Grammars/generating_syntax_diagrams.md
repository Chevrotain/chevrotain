...
Chevrotain provides an the [**createSyntaxDiagramsCode**](http://sap.github.io/chevrotain/documentation/2_0_2/globals.html#createsyntaxdiagramscode) API to generate the **html source code**
