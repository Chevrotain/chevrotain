...
The basic syntax for supplying a custom pattern is defined by the [ICustomPattern](http://sap.github.io/chevrotain/documentation/0_27_1/interfaces/_chevrotain_d_.icustompattern.html) interface.
Example:
...
It is important to note again that The matchedTokens and groups arguments match the token and groups properties of the tokenize output ([ILexingResult](http://sap.github.io/chevrotain/documentation/0_27_1/interfaces/_chevrotain_d_.ilexingresult.html)).
