...
when the parser uses a larger than the default [maxLookahead](https://sap.github.io/chevrotain/documentation/3_7_2/interfaces/iparserconfig.html#maxlookahead)
...
1.  **Do not create a new Parser instance for each new input**.
    ...
    Simply override the Parser's [reset](https://sap.github.io/chevrotain/documentation/3_7_2/classes/parser.html#reset) method
    to accomplish that.
...
1.  Reduce the amount of Token position tracking the lexer performs.
    See The [ILexerConfig.positionTracking](https://sap.github.io/chevrotain/documentation/3_7_2/interfaces/ilexerconfig.html) property.
