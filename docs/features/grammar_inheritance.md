...
with the replacement of the [**RULE**](https://sap.github.io/chevrotain/documentation/3_7_4/classes/parser.html#rule)
DSL method with [**OVERRIDE_RULE**](https://sap.github.io/chevrotain/documentation/3_7_4/classes/parser.html#override_rule) method when needed.
