...
when the parser uses a larger than the default [maxLookahead](http://sap.github.io/chevrotain/documentation/0_29_0/interfaces/_chevrotain_d_.iparserconfig.html#maxlookahead)
...
1. **Do not create a new Parser instance for each new input**.
   ...
   Simply override the Parser's [reset](http://sap.github.io/chevrotain/documentation/0_29_0/classes/_chevrotain_d_.parser.html#reset) method
   to accomplish that.
...
1. Reduce the amount of Token position tracking the lexer performs.
   See The [ILexerConfig.positionTracking](http://sap.github.io/chevrotain/documentation/0_29_0/interfaces/_chevrotain_d_.ilexerconfig.html) property.
