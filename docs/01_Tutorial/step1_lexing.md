...
A Lexer transforms a string input into a [Token](http://sap.github.io/chevrotain/documentation/1_0_1/interfaces/_chevrotain_d_.itoken.html) vector.
...
We will use the [**createToken** API](http://sap.github.io/chevrotain/documentation/1_0_1/modules/_chevrotain_d_.html#createtoken) 
