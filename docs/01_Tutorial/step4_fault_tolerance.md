...
* [canTokenTypeBeInsertedInRecovery](http://sap.github.io/chevrotain/documentation/3_0_1/classes/parser.html#cantokentypebeinsertedinrecovery)
  
* [getTokenToInsert](http://sap.github.io/chevrotain/documentation/3_0_1/classes/parser.html#gettokentoinsert)
...
To the parser's constructor [constructor](http://sap.github.io/chevrotain/documentation/3_0_1/classes/parser.html#constructor).


#### CST output for re-synced rules:
When using [Concrete Syntax Tree](../02_Deep_Dive/concrete_syntax_tree.md) output
A re-synced will return a CSTNode with the boolean ["recoveredNode"](http://sap.github.io/chevrotain/documentation/3_0_1/interfaces/cstnode.html#recoverednode) flag marked as true.
...
Customization is done during the definition of the grammar [RULE](http://sap.github.io/chevrotain/documentation/3_0_1/classes/parser.html#rule).
...
This is (once again) done during the definition of the grammar [RULE](http://sap.github.io/chevrotain/documentation/3_0_1/classes/parser.html#rule).
