...
- **Browser**:
  ...
  - Explicit version number:
    - `https://unpkg.com/chevrotain@8.0.1/lib/chevrotain.js`
    - `https://unpkg.com/chevrotain@8.0.1/lib/chevrotain.min.js`
    - `https://unpkg.com/chevrotain@8.0.1/lib_esm/chevrotain.mjs`
    - `https://unpkg.com/chevrotain@8.0.1/lib_esm/chevrotain.min.mjs`
