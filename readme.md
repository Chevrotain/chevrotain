<p align="center"><img src="Design/icon.png" alt="chevrotain" height="250px"></p>
...
-   **Browser**:
    ...
    -   Explicit version number:
        -   `https://unpkg.com/chevrotain@3.7.2/lib/chevrotain.js`
        -   `https://unpkg.com/chevrotain@3.7.2/lib/chevrotain.min.js`
...
-   **[HTML API docs](https://sap.github.io/chevrotain/documentation).**
    ...
    -   [The Parsing DSL Docs](https://sap.github.io/chevrotain/documentation/3_7_2/classes/parser.html#at_least_one).
