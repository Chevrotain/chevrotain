...
- **Browser**:
  ...
  - Explicit version number:
    - `https://unpkg.com/chevrotain@9.0.0/lib/chevrotain.js`
    - `https://unpkg.com/chevrotain@9.0.0/lib/chevrotain.min.js`
    - `https://unpkg.com/chevrotain@9.0.0/lib_esm/chevrotain.mjs`
    - `https://unpkg.com/chevrotain@9.0.0/lib_esm/chevrotain.min.mjs`
