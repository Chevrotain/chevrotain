...
Chevrotain provides an the [**createSyntaxDiagramsCode**](http://sap.github.io/chevrotain/documentation/1_0_0/modules/_chevrotain_d_.html#createsyntaxdiagramscode) API to generate the **html source code**
